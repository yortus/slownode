...
import unescapeString from './util/unescape-string';
...
export default function parse(text: string, reviver?: Reviver | Reviver[]): {} {
    ...
    function parseValue(src: Source, path: string[]): {} {
        ...
        if (lookahead === '{' || lookahead === '[') {
            ...
            // Parse all pairs/elements in the object/array.
            ...
            if (isDPO) {
                let revived = (<Reviver> reviver).call(null, path.length === 0 ? '' : path[path.length - 1], obj);
