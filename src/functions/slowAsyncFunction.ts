...
var SlowAsyncFunction: SlowAsyncFunctionStatic = <any> makeCallableClass({
    ...
    call: function (...args: any[]): Promise<any> {

        // Create a new SlowAsyncFunctionActivation instance to run the async operation.
        var safa = new SlowAsyncFunctionActivation((<SlowAsyncFunction> this), args); // TODO: must be log-bound SAFA!
