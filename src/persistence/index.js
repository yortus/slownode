...
function created(slowObj) {
    //TODO:...
    console.log("CREATED   kind:" + slowObj.$slow.kind + "   id:" + slowObj.$slow.id);
...
function updated(slowObj) {
    //TODO:...
    console.log("UPDATED   kind:" + slowObj.$slow.kind + "   id:" + slowObj.$slow.id);
    assert(trackedObjects.has(slowObj));
    assert(!weakReferences.has(slowObj));
...
function deleted(slowObj) {
    //TODO:...
    console.log("DELETED   kind:" + slowObj.$slow.kind + "   id:" + slowObj.$slow.id);
    assert(trackedObjects.has(slowObj));
    assert(!weakReferences.has(slowObj));
    if (pendingCreates.has(slowObj)) {
