...
//import SlowRoutineFunction = require('../src/coroutines/slowRoutineFunction');
//import SlowRoutine = require('../src/coroutines/slowRoutine');
...
//        var result = [];
//        var slowfunc = SlowRoutineFunction(fn, { yieldIdentifier: '__yield', constIdentifier: '__const' });
//        var sloro: SlowRoutine = slowfunc.apply(null, args);
//        while (true) {
//            try {
